...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        output_1, cache_1 = affine_relu_forward(X, W1, b1)
        output_2, cache_2 = affine_forward(output_1, W2, b2)
        scores = output_2
        ...
        dx_2, dW2, db2 = affine_backward(dx, cache_2)
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        for i in range(self.num_layers):
            ...
            w = self.params[weights_name]
            b = self.params[bias_name]

            if i+1 == self.num_layers:
                scores, new_cache = affine_forward(output, w, b)
            else:
                output, new_cache = affine_relu_forward(output, w, b)
        ...
        for i in range(self.num_layers):
            ...
            if i == 0:
                ...
                dx, dw, db = affine_relu_backward(dx, caches[-1-i])

            dw += self.reg * self.params[weights_name]
